 ...
 *
 * Esta clase configura la documentación interactiva de la API usando SpringDoc OpenAPI.
 * Incluye configuración de seguridad JWT para poder probar endpoints protegidos.
 */
@Configuration
